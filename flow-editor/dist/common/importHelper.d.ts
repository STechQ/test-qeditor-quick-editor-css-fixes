...
export declare function importModule<T>(path: string, require: (name: string) => any, importField?: string): Promise<T>;
export declare function importModuleFile(path: string): Promise<string>;
export declare function importModuleBody<T>(moduleJs: string, require: (name: string) => any, importField?: string): T;
